...
import { getAdminEmails, sendNewRegistrationEmail } from "@/lib/email-service";
...
const CreateProfile = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Email à l'admin (notification nouvelle inscription)
      try {
        // Récupérer les emails admin depuis la base de données
      ...
      toast.success(
        "Profil complété ! Vous recevrez un email lorsque votre profil sera validé."
      );
